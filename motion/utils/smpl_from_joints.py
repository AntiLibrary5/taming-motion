# Taken from https://github.com/Mael-zys/T2M-GPT/blob/main/visualize/simplify_loc2rot.py#L13
import sys
import numpy as np
import os
import torch
from motion.utils.joints2smpl.src import config
import smplx
import h5py
import motion.utils.smpl_body_utils as smpl_body_utils
from motion.utils.joints2smpl.src.smplify import SMPLify3D
